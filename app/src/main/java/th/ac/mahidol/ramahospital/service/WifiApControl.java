 ...
 * Modified 2019 Jirawat I.
 *  - Android 9.0 API28 deletes setWifiApEnabled
 *
...
public final class WifiApControl {
    ...
    private static boolean isSoftwareSupported() {
        if (getWifiApConfigurationMethod == null) Log.e(TAG, "getWifiApConfiguration is null");
        if (getWifiApStateMethod == null) Log.e(TAG, "getWifiApState is null");
        if (isWifiApEnabledMethod == null) Log.e(TAG, "isWifiApEnabled is null");
